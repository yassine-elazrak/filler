...
/*   Updated: 2019/10/02 20:20:05 by yelazrak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    	// printf("stra = %d			end = %d		pvot = [%d]	\n",(*lst_a)->data,(*lst_a)->end->data,pvot);
        // if (( *lst_b != NULL && (*lst_b)->next != NULL))
        //      printf("bbbbb  s tra  = %d			end = %d			\n",(*lst_b)->data,(*lst_b)->end->data);
   
    
     if (( *lst_b != NULL && (*lst_b)->next != NULL && (((*lst_a)->end->data < pvot) ||  (*lst_b)->data > (*lst_b)->end->data) &&
        (*lst_b)->data < (*lst_b)->end->data))
     ...
     else  if (( *lst_b != NULL && (*lst_b)->next != NULL && ((*lst_b)->data <(*lst_b)->end->data)))// || (*lst_b)->data < pvot_b)))
    {
     ...
     else if (( *lst_b != NULL && (*lst_b)->next != NULL && (*lst_a)->data > pvot) &&
       (((*lst_b)->data < (*lst_b)->end->data)))
    ...
    else if ( *lst_a != NULL && (*lst_a)->next != NULL &&  (*lst_a)->data <= pvot)
     {
       ...
       // if (( *lst_b != NULL && (*lst_b)->next != NULL &&  (*lst_b)->data < pvot_b))
        // {
        //    // printf("pvot_bbb = %d     pvot = %d\n",pvot_b, pvot);
        //       ft_exec(lst_a, lst_b, "rb");
        // }
